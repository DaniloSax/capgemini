<template>
  <div style="height: 50px;" class="border-top bg-blue">
    <div
      class="row align-center justify-end bg-blue-4"
    ...
    >
      <div class="row justify-around q-py-xs ">
        <div class="q-mx-md column text-white">
          ...
          />
          <span v-else>
            <b>Ag</b> {{ account.agency }} <b>Cc</b> {{ account.account }}
          </span>
        </div>

        <q-separator spaced inset vertical dark />
        <div
          class="q-mx-md column"
          :class="account.balance < 0 ? 'text-negative' : 'text-white'"
        >
